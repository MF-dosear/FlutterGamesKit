...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../../FlutterGamesKit/Frameworks/path_provider_foundation.framework"
  install_framework "${PODS_ROOT}/../../FlutterGamesKit/Frameworks/shared_preferences_foundation.framework"
  install_framework "${PODS_ROOT}/../../FlutterGamesKit/Frameworks/share_plus.framework"
